...
from django.db.models import CASCADE, Q, Sum
...
class Realm(models.Model):
    ...
    create_stream_policy = models.PositiveSmallIntegerField(default=POLICY_MEMBERS_ONLY)
...
class AbstractPushDeviceToken(models.Model):
    ...
    ios_app_id: Optional[
        "TextField[Union[str, Combinable, None], Optional[str]]"
...
class UserTopic(models.Model):
    ...
    date_muted = models.DateTimeField(default=datetime(2020, 1, 1, 0, 0, tzinfo=timezone.utc))
...
class Subscription(models.Model):
    ...
    is_muted = models.BooleanField(null=True, default=False)
...
class UserStatus(AbstractEmoji):
    ...
    status = models.PositiveSmallIntegerField(default=NORMAL)
